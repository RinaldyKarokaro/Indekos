...
<section class="popular-deals section">
	<div class="container">
            ...
            <div class="col-md-12">
                <h3 style="margin-left:-3%;padding:2%;">Fasilitas Outdoor</h3>
            </div>
            ...
            <div class="col-md-12" style="border:1px solid;box-shadow: 5px 2px #888888;padding:3%;border-radius:10px 10px 10px 10px;">
                ...
                <div class="col-md-12" style="padding:3%;text-align:center;margin-bottom:auto;">
                   <a href="#"><h3 style="font-size:90%;">Lihat semua</h3></a>
                </div>
            </div>
	</div>
</section>
